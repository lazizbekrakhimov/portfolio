  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[20, 40, 60, 80].map(p => (
          <div key={p} className="absolute left-0 right-0 h-px" style={{ top: `${p}%`, background: 'var(--border)', opacity: 0.5 }} />
        ))}
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 animate-slide-up" style={{ animationDelay: '0.5s', opacity: 0 }}>

          <p className="text-sm tracking-wide max-w-mb" style={{ color: 'var(--muted)', fontStyle: 'italic' }}>
            <span className="font-serif" style={{ fontSize: '1.2rem', color: 'var(--fg)' }}>
              "{tr.tagline}"
            </span>
          </p>
